...
func newFastconnectBgpSession() *prometheus.GaugeVec {
...
func GetFastconnectBGPSessionState(ctx context.Context, fastconnectBgpSession *prometheus.GaugeVec) error {
