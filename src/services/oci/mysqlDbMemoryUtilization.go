...
func newMysqlDbMemoryUtilization() *prometheus.GaugeVec {
	return prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Namespace: "oci_exporter",
			Name:      "mysql_db_memory_utilization",
			Help:      "Memory Utilization of OCI MySQL Database.",
		},
		[]string{
			"compartment_id",
			"resource_name",
...
func GetMysqlDbMemoryUtilization(ctx context.Context, mysqlDbMemoryUtilization *prometheus.GaugeVec) error {
	mysqlDbMemoryUtilization.Reset()
	...
	err := getMysqlDbMemoryUtilizationByCompartment(
		ctx,
		compartmentId,
		query,
		namespaceQuery,
...
func getMysqlDbMemoryUtilizationByCompartment(
	ctx context.Context,
	compartmentId string,
	query string,
	namespaceQuery string,
	mysqlDbMemoryUtilization *prometheus.GaugeVec,
) error {
	...
	for _, metric := range resp.Items {
		...
		// set gauge value
		mysqlDbMemoryUtilization.With(prometheus.Labels{
